    <div id="contain3">
    <center><h3>Menu Admin</h3></center>
    ...
    <div class="row">
        <div class="span4">
            <h2>Data Kreditur</h2>
            <p>Pada menu ini memberikan informasi mengenai peserta calon penerima kredit.
            Kreditur yang telah mengajukan permintaan kepada BPR Arthajaya akan terdaftar di sini</p>
            <p>
        ...
        <div class="span4">
            <h2>Data Kriteria</h2>
            <p>Pada menu ini memberikan informasi mengenai kredit yang tersedia.
            Calon peserta bisa menjadikan informasi tersebut sebagai referensi dalam mendaftar penerima kredit</p>
            <p>
                <a class="btn" href="<?php echo site_url('welcome/lahan');?>">Lihat Selengkapnya  &rsaquo;&rsaquo;</a>
            </p>
        </div>
        <div class="span4">
            ...
            <p>Pada menu ini memberikan informasi mengenai kriteria kriteria dalam memilih penerima kredit</p>
            <p>
                <a class="btn" href="<?php echo site_url('welcome/lahan');?>">Lihat Selengkapnya  &rsaquo;&rsaquo;</a>
            </p>
        </div>
